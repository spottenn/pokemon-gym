...
class PokemonEnvironment:
    ...
    def __init__(self, rom_path: str, headless: bool = True, sound: bool = False, streaming_mode: bool = False):
        """
        ...
        """
        self.emulator = Emulator(rom_path, headless, sound, streaming_mode)
